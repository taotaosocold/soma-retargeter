...
class Viewer:
    def __init__(self, viewer, config):
        ...
        target_from_config = config.get('retarget_target', 'unitree_g1')
        if target_from_config in self.retarget_target_options:
            self.retarget_target_idx = self.retarget_target_options.index(target_from_config)
        else:
        ...
        self._build_viewer_robot(target_from_config)
    ...
    def _build_viewer_robot(self, target):
